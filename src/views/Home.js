...
const valueHasMinLength = (value, errorHandlerSetter, errorMessage, minLen = 2) => 
{
    if(value.length < minLen){
        errorHandlerSetter(errorMessage);
        return;
    }
    errorHandlerSetter("");
}

const validateEmail = (value, errorHandlerSetter, errorMessage) => 
{
...
const submithandler = async (e) => {
    ...
    await fetch('https://ecexam-webapi.azurewebsites.net/api/customers', requestOptions)
}
